...
const GamaraOuter360NightLow = () => {
    const [value, setValue] = useState(0);
    const [currentImage, setCurrentImage] = useState("/Gamara_Night_Low/00.webp");
    const requestRef = useRef(null);
    const targetValue = useRef(value);

    const imageCount = 61;
    const images = Array.from({ length: imageCount }, (_, i) =>
        `/Gamara_Night_Low/${String(i).padStart(2, "0")}.webp`
    );
    ...
    useEffect(() => {
        const animate = () => {
            ...
            setCurrentImage(`/Gamara_Night_Low/${String(value).padStart(2, "0")}.webp`);
...
export default GamaraOuter360NightLow;
