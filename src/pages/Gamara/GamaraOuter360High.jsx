...
const GamaraOuter360High = () => {
    const [value, setValue] = useState(0);
    const [currentImage, setCurrentImage] = useState("/gamara_high/00.webp");
    const requestRef = useRef(null);
    const targetValue = useRef(value);

    const imageCount = 61;
    const images = Array.from({ length: imageCount }, (_, i) =>
        `/gamara_high/${String(i).padStart(2, "0")}.webp`
    );
    ...
    useEffect(() => {
        const animate = () => {
            ...
            setCurrentImage(`/gamara_high/${String(value).padStart(2, "0")}.webp`);
...
export default GamaraOuter360High;
