...
const MarinaBay4BHK = () => {
    ...
    const [currentImage, setCurrentImage] = useState("/Marina_Bay/4bhk/00.webp");
    const requestRef = useRef(null);
    const targetValue = useRef(value);

    const imageCount = 59;
    const images = Array.from({ length: imageCount }, (_, i) =>
        `/Marina_Bay/4bhk/${String(i).padStart(2, "0")}.webp`
    );
    ...
    useEffect(() => {
        const animate = () => {
            ...
            setCurrentImage(`/Marina_Bay/4bhk/${String(value).padStart(2, "0")}.webp`);
