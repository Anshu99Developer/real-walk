...
import SeaBeeezeLeftSideBarNav from "./SeaBeeezeLeftSideBarNav";

const SeaBreezeMenuLayout = ({ children }) => {
  return (
    <div className="h-[100dvh] w-[100dvw]">
      ...
      <SeaBeeezeLeftSideBarNav />
      {children}
    </div>
  );
};

export default SeaBreezeMenuLayout;
